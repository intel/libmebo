...
class Libmebo_brc
{
	public:
        ...
        virtual LibMeboRateController*  init(LibMeboRateController* rc,
	LibMeboRateControllerConfig* rc_config) = 0;
        virtual LibMeboStatus update_config(LibMeboRateController* rc,
            LibMeboRateControllerConfig* rc_cfg) = 0;
        virtual LibMeboStatus post_encode_update(LibMeboRateController* rc,  uint64_t encoded_frame_size) = 0;
        virtual LibMeboStatus compute_qp(LibMeboRateController *rc, LibMeboRCFrameParams* rc_frame_params) = 0;
        virtual LibMeboStatus get_qp(LibMeboRateController* rc, int* qp) = 0;
        virtual LibMeboStatus get_loop_filter_level(LibMeboRateController* rc, int* filter_level) = 0;
        ...
        LibMeboCodecType getCodecType() const {
            return codec_type;
        }
    protected:
